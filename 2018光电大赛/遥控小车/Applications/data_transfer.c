...
void ANO_DT_Data_Exchange(void)
{
    ...
    {
			case 0:	
				ANO_DT_Send_User(1,CM1Speed.exp,CM1Speed.fdb,CM2Speed.exp,CM2Speed.fdb,5,6,7,8,9,10);
			break;
			case 1:
				ANO_DT_Send_User(1,CM3Speed.exp,CM3Speed.fdb,CM4Speed.exp,CM4Speed.fdb,5,6,7,8,9,10);
			break;
			default: break;
		}
//    switch((u8)pid_setup.groups.pid_18.kd)
