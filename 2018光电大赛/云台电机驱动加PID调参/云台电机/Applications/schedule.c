...
void Duty_1ms()
{
	float Duty_1ms_loop_time; 
	
  Duty_1ms_loop_time = Get_Cycle_T(1)/1000000.0f;
	
	ANO_DT_Data_Exchange();
	
	GMY_Val_Cal(Duty_1ms_loop_time);
}
...
void Duty_5ms()
{
	...
	test[2] = GetSysTime_us()/1000000.0f;
 	...
 	if(task_on == 1)
		GMYawControlLoop(outer_loop_time);
